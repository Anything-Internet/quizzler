...
class GameBrain {
  List<Question> _questions = loadQuestions();
  int _currentQuestion = -1;
  int _questionsAsked = -1;
  ...
  bool get getAnswer => _questions[_currentQuestion].questionAnswer;
  ...
  get questionsAskedString => _questionsAsked.toString();
  get questionsCorrectString => _questionsCorrect.toString();
  get questionsIncorrectString => _questionsIncorrect.toString();
  get questionsRemainingString => (totalQuestions - _questionsAsked).toString();

  get questionsCorrectPercentString {
    double score = 0;
    if(_questionsAsked > 0) {
      score = (_questionsCorrect / _questionsAsked) * 100;
      return score.toStringAsFixed(0);
    }
    return "0";
  }

  get questionsWrongPercentString {
    double score = 0;
    if(_questionsAsked > 0) {
      score = (_questionsIncorrect / _questionsAsked) * 100;
      return score.toStringAsFixed(0);
    }
    return "0";
  }
